  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          blockItem("XML và ứng dụng - Nhóm 1", "2025–2026.1.TIN4583.001", "58 học viên", Colors.grey.shade900),
          blockItem("Lập trình ứng dụng cho các thiết bị di động - Nhóm 1", "2025–2026.1.TIN4403.006", "55 học viên", Colors.grey.shade800),
          ...
          blockItem("Lập trình ứng dụng cho các thiết bị di động - Nhóm 4", "2025–2026.1.TIN4403.003", "52 học viên", Colors.grey.shade900),
        ],
      ),
    );
  }
